...
Before starting review work, call `list_threads` and then rename the current
Codex task with `set_thread_title`. Use `[<ticket-id> ]<description>: review`,
...
`UIB-4442 usage credits report: review`.
